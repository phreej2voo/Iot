...
) ENGINE = MyISAM CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TCP建立连接设备参数记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TCP服务接收设备数据记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for iot_dispatch_log
-- ----------------------------
DROP TABLE IF EXISTS `iot_dispatch_log`;
CREATE TABLE `iot_dispatch_log`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'TCP建立连接设备分发日志记录表' ROW_FORMAT = Dynamic;
